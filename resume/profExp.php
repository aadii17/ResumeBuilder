...
<body>
    ...
    <section class="form">
        <br><br><br>
        <h1 style="color: black;" class="text-center justify-content-center">Recent Professional Experience</h1>
        <h4 class="text-center justify-content-center">Add your most recent job and continue in descending order.</h4>
        <br><br>
        <div class="container">

            <form action="profExp_mid.php" method="post">
                <div class="row justify-content-md-center">
                  ...
                  aria-describedby="emailHelp" placeholder="Enter your position" />
                            </div>
                            <div class="col-md-4">
                                <label for="cname">Company Name</label>
                                <input type="text" class="form-control" name="cname" id="exampleInputEmail1"
                  aria-describedby="emailHelp" placeholder="Enter compamy name" />
                            </div>
                        </div>
                  ...
                  <label for="work">I Currently Work Here</label>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-md-8">
                                <label for="Description">Highlight your specific work experience</label>
                                <textarea name="prof_des" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                    <br>
